...
import {postUser, getUsers, putUserById, deleteUserById, deleteUserByemail, getUserById } from "../controllers/users.controller.js";
...
userRouter.get("/mostrarUsuario/:id" ,getUserById); 
